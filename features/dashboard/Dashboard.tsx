...
const StatCard: React.FC<{
    ...
    <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-36 relative overflow-hidden group hover:shadow-md transition-all duration-300">
        ...
        <div className="relative z-10">
            {loading ? (
                <div className="h-8 w-24 bg-gray-200 rounded animate-pulse my-1"></div>
            ) : (
                ...
                <div className="xl:col-span-2 bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden h-full flex flex-col">
                    <div className="flex justify-between items-center mb-4 shrink-0">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-indigo-50 text-indigo-600 rounded-lg"><MapIcon className="w-5 h-5" /></div>
                                ...
                                <div className="flex-1 flex items-center gap-4">
                                    <div className="relative w-32 h-32 shrink-0">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                            <span className="text-xl font-black text-gray-800">{projects?.length || 0}</span>
