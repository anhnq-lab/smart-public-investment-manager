    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                {/* Active */}
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700 text-white p-3 shadow-lg ring-1 ring-emerald-400/30 transition-all duration-200">
                ...
                {/* Departments */}
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-violet-500 via-violet-600 to-purple-700 text-white p-3 shadow-lg ring-1 ring-violet-400/30 transition-all duration-200">
                    <div className="absolute -right-2 -top-2 opacity-[0.12]">
                ...
                {/* Admins */}
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-500 via-purple-600 to-fuchsia-700 text-white p-3 shadow-lg ring-1 ring-purple-400/30 transition-all duration-200 cursor-pointer"
